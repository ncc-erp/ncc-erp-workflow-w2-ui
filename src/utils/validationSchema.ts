...
export const getValidationDirectorSettingForm = () => {
  const t = (key: string) => i18n.t(key);
...
export const getValidationSettingForm = () => {
  const t = (key: string) => i18n.t(key);
...
export const validationDirectorSettingForm = getValidationDirectorSettingForm();
export const validationSettingForm = getValidationSettingForm();
